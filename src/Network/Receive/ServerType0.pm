...
sub new {
	...
	$self->{packet_list} = {
		...
		'0983' => ['actor_status_active', 'v a4 C V4', [qw(type ID flag total tick unknown1 unknown2 unknown3)]],
		'0984' => ['actor_status_active', 'a4 v V4', [qw(ID type total tick unknown1 unknown2 unknown3)]],
